-- =============================================================================
-- DUAL GYM – Esquema completo para Postgres Sandbox
-- En Supabase: omite la sección "SIMULACIÓN AUTH" (hasta el comentario de fin).
-- Supabase ya tiene auth.users y auth.uid().
-- =============================================================================

-- -----------------------------------------------------------------------------
-- SIMULACIÓN AUTH (solo para sandbox; no ejecutar en Supabase)
-- -----------------------------------------------------------------------------
...
-- Función que en Supabase ya existe; en sandbox devuelve el primer usuario o un UUID fijo.
...
-- Comentario: fin de simulación auth
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- RLS (Row Level Security) – usan auth.uid()
-- -----------------------------------------------------------------------------
...
-- Profiles: cada usuario ve y edita solo el suyo; admins ven todos (por role en profile)
...
-- Plans: lectura pública para que cualquiera vea planes; escritura solo admin (opcional, aquí solo SELECT)
...
-- Subscriptions: usuario ve las suyas; admins ven todas
...
-- Payments: usuario ve los suyos; admins ven todos
...
-- Check-ins: usuario ve y crea los suyos; admins ven todos
...
-- -----------------------------------------------------------------------------
-- DATOS INICIALES (opcional): un plan de ejemplo
-- -----------------------------------------------------------------------------
